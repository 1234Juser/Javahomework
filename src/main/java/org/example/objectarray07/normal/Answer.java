...
public class Answer {
    public static void main(String[] args) {
        ...
        if(athletes[0].record>athletes[1].record){
            if(athletes[0].record>athletes[2].record){
                System.out.println("최고 기록 : " +athletes[0].record);
            }}else if(athletes[1].record>athletes[2].record){
                if(athletes[1].record>athletes[0].record){
                    System.out.println("최고 기록 : " +athletes[1].record);
                }}else if(athletes[2].record>athletes[1].record){
                    if(athletes[2].record>athletes[0].record){
                        System.out.println("최고 기록 : " +athletes[2].record);
                    }
                }
            }
        }
